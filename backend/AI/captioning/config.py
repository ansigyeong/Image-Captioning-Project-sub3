...
class Config(object):
    ...
    def __init__(self):
        ...
        self.vocabulary_file = '/home/ubuntu/s03p23d107/backend/AI/captioning/vocabulary.csv'
        self.vocabulary_size = 5000

        # about the training
        self.train_image_dir = './train/images/'
        self.train_caption_file = '/home/ubuntu/s03p23d107/backend/AI/captioning/train/captions_train2014.json'
        ...
        # about the testing
        self.test_image_dir = '/home/ubuntu/s03p23d107/backend/AI/captioning/test/images/'
        self.test_result_dir = '/home/ubuntu/s03p23d107/backend/AI/captioning/test/results/'
        self.test_result_file = '/home/ubuntu/s03p23d107/backend/AI/captioning/test/results.csv'
